...
fun SignUpUi(navController: NavController,
    ...
    val isConfirmPasswordVisible = viewModel.isConfirmPasswordVisible
...
Box(modifier = Modifier
    ...
    Column(modifier = Modifier.align(Alignment.Center)) {
        ...
        OutlinedTextField(
            ...
            trailingIcon = {
                AnimatedVisibility(
                    visible = confirmPassword.isNotBlank()
                ) {
                    Icon(
                        painter = if (isConfirmPasswordVisible) painterResource(R.drawable.show)
                        else painterResource(R.drawable.hide),
                        contentDescription = null,
                        modifier = Modifier
                            .size(20.dp)
                            .clickable(
                                ...
                                viewModel.setConfirmPasswordVisibility()
                            }
                    )
                }
            }
    ...
    if (signUpState is SignUpState.Error){
        ErrorModal(
            ...
            text= stringResource((signUpState as SignUpState.Error).error.toMessageRes())
        )
    }
}
